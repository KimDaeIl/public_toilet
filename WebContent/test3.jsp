...
<html>
 <head>
  ...
  <body>	
  		<p align="right"><a href = "#" style="text-decoration:none">로그인</a> &nbsp;&nbsp;
		<a href = "#" style="text-decoration:none">ID/PW 찾기</a>&nbsp;&nbsp;
		<a href = "#" style="text-decoration:none">회원 등록</a>&nbsp;</TH>
    <div id="jb-container">
      <div id="jb-header">
		<h3>tOilet</h3>
      </div>
    <div id="jb-content">
		...
		function addMarker(position, idx, title) {
		    var imageSrc = 'http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/marker_number_blue.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
		    	imageSize = new daum.maps.Size(60, 60),  // 마커 이미지의 크기
	     	    imgOptions =  {
